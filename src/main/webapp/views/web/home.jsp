...
<body>
    ...
    <div class="container-fluid">
        <div class="owl-banner owl-carousel">
            <div class="item">
                <img src="${pageContext.request.contextPath}/template/web/assets/images/banner-item-01.jpg" alt="">
            ...
            <div class="item">
                <img src="${pageContext.request.contextPath}/template/web/assets/images/banner-item-02.jpg" alt="">
                <div class="item-content">
                    <div class="main-content">
                        <div class="meta-category">
                            <span>Nature</span>
            ...
            <div class="item">
                <img src="${pageContext.request.contextPath}/template/web/assets/images/banner-item-03.jpg" alt="">
                <div class="item-content">
                    <div class="main-content">
                        <div class="meta-category">
                            <span>Lifestyle</span>
            ...
            <div class="item">
                <img src="${pageContext.request.contextPath}/template/web/assets/images/banner-item-04.jpg" alt="">
                <div class="item-content">
                    <div class="main-content">
                        <div class="meta-category">
                            <span>Fashion</span>
            ...
            <div class="item">
                <img src="${pageContext.request.contextPath}/template/web/assets/images/banner-item-05.jpg" alt="">
                <div class="item-content">
                    <div class="main-content">
                        <div class="meta-category">
                            <span>Nature</span>
            ...
            <div class="item">
                <img src="${pageContext.request.contextPath}/template/web/assets/images/banner-item-06.jpg" alt="">
                <div class="item-content">
                    <div class="main-content">
                        <div class="meta-category">
                            <span>Lifestyle</span>
                ...
                <div class="all-blog-posts">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="blog-post">
                                <div class="blog-thumb">
                                    <img src="${pageContext.request.contextPath}/template/web/assets/images/blog-post-01.jpg" alt="">
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="blog-post">
                                <div class="blog-thumb">
                                    <img src="${pageContext.request.contextPath}/template/web/assets/images/blog-post-02.jpg" alt="">
                                </div>
                                <div class="down-content">
                                    <span>Healthy</span>
                        ...
                        <div class="col-lg-12">
                            <div class="blog-post">
                                <div class="blog-thumb">
                                    <img src="${pageContext.request.contextPath}/template/web/assets/images/blog-post-03.jpg" alt="">
                                </div>
                                <div class="down-content">
                                    <span>Fashion</span>
